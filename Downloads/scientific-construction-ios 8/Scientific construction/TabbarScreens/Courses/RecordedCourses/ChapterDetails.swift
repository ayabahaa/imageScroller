...
import UIKit
import Parchment
class ChapterDetails: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
         ...
         let storyboard = UIStoryboard(name: "Main", bundle: nil)
                         let firstViewController = storyboard.instantiateViewController(withIdentifier: "ChapterDetails2")
                         let secondViewController = storyboard.instantiateViewController(withIdentifier: "MoreVC")
