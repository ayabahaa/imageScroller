...
extension AvailableCoursesVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.courseButton.setTitle("تسجيل", for: .normal)
        cell.actionButton = {
            Utility.showAlertMessage(withTitle: "البناء العلمي", message: "تم تسجيل الدورة بنجاح", delegate: nil, parentViewController: self)
        }
...
extension AvailableCoursesVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
