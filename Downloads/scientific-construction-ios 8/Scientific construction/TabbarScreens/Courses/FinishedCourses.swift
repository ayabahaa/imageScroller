...
class FinishedCourses: UIViewController {
    ...
    var Avalible : AllCoursesModel?
      ...
      extension FinishedCourses: UITableViewDelegate, UITableViewDataSource {
          ...
          func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
              ...
              cell.courseButton.setTitle("تم انهاء الدورة", for: .normal)
              return cell
          }
      ...
      extension FinishedCourses: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
